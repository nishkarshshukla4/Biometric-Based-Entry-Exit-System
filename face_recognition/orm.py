...
def register_face(enroll):
    ...
    while True:
      ...
      # os.chdir("/home/rsvi/Desktop/Mini_Project_sem5/face_recognition-master/examples")
        os.chdir("/home/nishkarsh/Desktop/check/face_recognition-master/")
        if ret:
...
def recognize_face():
    video_capture = cv2.VideoCapture(0)
    connection = sqlite3.connect('/home/nishkarsh/Desktop/check/face_recognition-master/face_recognition/proj_database.db')
