...
def registration():
    ...
    if form.validate_on_submit():
        ...
        if orm.check_unique(roll_no,form.contact.data)==3:
            ...
            return redirect(url_for('registration'))
        shutil.copyfile('/home/nishkarsh/Desktop/check/face_recognition-master/face_recognition/orm.py', '/home/nishkarsh/Desktop/check/face_recognition-master/face_recognition/temp.py')
        shutil.copyfile('/home/nishkarsh/Desktop/check/face_recognition-master/face_recognition/orm1.py', '/home/nishkarsh/Desktop/check/face_recognition-master/face_recognition/orm.py')
        shutil.copyfile('/home/nishkarsh/Desktop/check/face_recognition-master/face_recognition/temp.py', '/home/nishkarsh/Desktop/check/face_recognition-master/face_recognition/orm1.py')
...
def hostel_entry():
    ...
    if form.validate_on_submit():
        ...
        if(orm.check(roll_no)):
            flash(f'Student already outside', "danger")
...
def main_entry():
    ...
    # shutil.copyfile('/home/nishkarsh/Desktop/check/face_recognition-master/face_recognition/orm1.py', '/home/nishkarsh/Desktop/check/face_recognition-master/face_recognition/orm.py')
    # shutil.copyfile('/home/nishkarsh/Desktop/check/face_recognition-master/face_recognition/temp.py', '/home/nishkarsh/Desktop/check/face_recognition-master/face_recognition/orm1.py')
    enroll=(orm.recognize_face()).upper()
    if(orm.check(enroll)):
        if(orm.main_exit(enroll)==False):
            flash(f'Student is already inside the campus', 'danger')
            return redirect(url_for('main_page'))
